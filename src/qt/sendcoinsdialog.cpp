    ...
    model(0)
{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a profoundprofitchain address"));
#endif
     ...
     if (model)
     {
        ...
        if (text.isEmpty())
         ...
         else if (!CBitcoinAddress(text.toStdString()).IsValid())
         {
             ...
             ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid profoundprofitchain address"));
         }
         else
         {
